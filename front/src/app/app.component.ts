...
export class AppComponent {
  ...
  CREATE_tarefa(descricaoNovaTarefa: string) {
    ...
    this.http
      .post<Tarefa>(`${this.apiURL}/api/post`, novaTarefa, { 'headers': idToken })
      .subscribe((resultado) => {
  ...
  DELETE_tarefa(tarefaAserRemovida: Tarefa) {
    ...
    this.http
      .delete<Tarefa>(`${this.apiURL}/api/delete/${id}`, { 'headers': idToken }).subscribe((resultado) => {
        console.log(resultado);
        this.READ_tarefas();
      });
  }
  ...
  UPDATE_tarefa(tarefaAserModificada: Tarefa) {
    ...
    var id = this.arrayDeTarefas[indice]._id;
    this.http
      .patch<Tarefa>(`${this.apiURL}/api/update/${id}`, tarefaAserModificada, { 'headers': idToken })
      .subscribe((resultado) => {
        console.log(resultado);
        this.READ_tarefas();
      });
